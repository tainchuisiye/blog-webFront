 ...
 */
const SecuredAuthorize = (authority, error?) => {
  /**
  ...
  return function decideAuthority(target) {
    ...
    const component = () => <Authority authority={authority}  noMatch={classError || Exception403} >{target}</Authority>;
    // CheckPermissions(authority, target, classError || Exception403);
    return checkIsInstantiation(component);
  };
};

export default SecuredAuthorize;
